...
class Load_Data:
    def __init__(self):
        ...
        # Атрибуты, которые будут инициализированы в процессе работы
        self.recent_logs: Optional[pd.DataFrame] = None
        self.interval_str: Optional[str] = None
        self.db_params: Optional[Dict[str, str]] = None
